...
- 除了四張 [Not Dead After All](https://cards.scryfall.io/large/front/d/0/d01a2b68-efe6-4027-846d-db7b19d9eef6.jpg?1692937773) 以外，還有兩張假死術的空間，看要放以前會帶的 [Undying Malice](https://cards.scryfall.io/large/front/8/e/8eb38041-043a-4b18-9d9a-f1283684e8f1.jpg?1643590441) 跟 [Feign Death](https://cards.scryfall.io/large/front/3/2/32af7061-fca6-4a06-be3c-01881e6b96f7.jpg?1627704817)，或是直接給不息的 [Undying Evil](https://cards.scryfall.io/large/front/3/2/325f2243-54fd-484b-a742-166cea7ec179.jpg?1562906805) 都可以
  個人比較 prefer Undying Evil，因為進場是站著進，有時可以拿來擋一些有敏捷的生物，（例如後手一回 Grief scam 的時候看到對手二回可以 dash Ragavan），不過缺點是沒辦法再救一次已經有豆子的生物，不過目前也只有 Undying Evil 會放豆就是了
...
備牌自由一些，不過通常 [Chalice of the Void](https://cards.scryfall.io/large/front/1/a/1a02ca71-5e39-4a5f-aaba-a1e3e10a6a3e.jpg?1562137287), [Engineered Explosives](https://cards.scryfall.io/large/front/4/2/420bf1e9-f2ec-4dff-b540-e64de71e58be.jpg?1599709112), [Sheoldred, the Apocalypse](https://cards.scryfall.io/large/front/d/6/d67be074-cdd4-41d9-ac89-0a0456c4e4b2.jpg?1674057568) 各二這六張牌不能動，有些人會帶三張 Chalice。
除了這幾張牌以外其他的部分通常是：

- 一到兩張額外的血月：總之正 + 備至少要兩張，如果環境比較多多色牌或是創則是要至少三張
- 至少三張的放墳：看要選用 [Leyline of the Void](https://cards.scryfall.io/large/front/0/4/04d5d429-e0c6-42cc-a477-da7dabb1c295.jpg?1592516724), [Nihil Spellbomb](https://cards.scryfall.io/large/front/e/5/e5892a23-efae-4731-9b8f-41c87960fe93.jpg?1562442193), [Unlicensed Hearse](https://cards.scryfall.io/large/front/9/3/93ee60f7-31dd-4bc6-b71f-57a1a0d19d20.jpg?1664414360) 都可以

剩下的部分則是看個人想要放什麼，例如我想要懲罰那些想要用戒指無敵一回合的玩家，所以備牌帶了兩張 [Bonecrusher Giant](https://cards.scryfall.io/large/front/b/5/b5b71cd2-de35-451f-b16e-2e3936169407.jpg?1674141884)，還有為了鱗甲帶了一張 [Hidetsugu Consumes All](https://cards.scryfall.io/large/front/8/e/8e910464-329a-4de1-930a-be85b1956676.jpg?1656453394)。

> `Protection from ~` 是包含了 `不能成為～來源的異能、咒語目標` 和 `防止～來源的傷害`，所以可以用 Stomp 使這回合的傷害無法被防止。

### Mardu Scam

最後提一下套牌的變種：Mardu Scam。
不過雖然說是瑪爾督色，但實際上的白只有備牌的三張餅乾拆 Wear // Tear，然後正編少一張紅黑快、多一張黑白電震地。
![](https://cards.scryfall.io/large/front/e/0/e01cc65a-0e38-4f41-b9ed-796ef0355d0b.jpg?1688375953)

不過現在的環境用不太到拆結界，需要用到的對局又通常需要上血月（打 Cascade Beanstalk/Omnath），個人感覺有點尷尬，不如直接起手 scam 快點把對手打死。
...
關於 Dauthi Voidwalker（因為全名太長了，後面都簡稱為 Dauthi）有不少規則需要注意的，這邊先簡單提一下，有空我們再來寫一篇文章好好說一說。
...
|           Side In            |          Side Out           |
| :--------------------------: | :-------------------------: |
|         +1 Terminate         | -4 Ragavan, Nimble Pilferer |
|    +3 Leyline of the Void    |      + -1 Undying Evil      |
| +2 Sheoldred, the Apocalypse |        -1 Blood Moon        |

這個對局我認為先後手很重要，先手一回 Grief scam 贏一半，中期資源差打出來後再 Fury scam 就好
下掉四張猴子是因為太容易被解掉；下掉一張假死術是因為很容易被反打，而且在沒有摸到元素時假死術沒什麼用，以 top deck value 來說沒有很好
...
| :--------------------------: | :-------------------------: |
|         +1 Terminate         | -4 Ragavan, Nimble Pilferer |
|    +1 Kolaghan's Command     |      -2 Lightning Bolt      |
|    +3 Leyine of the Void     |        -1 Blood Moon        |
| +2 Sheoldred, the Apocalypse |                             |

只要阻止組合技就好。
選擇下掉四張猴子是因為打不太出資源差，對手的資源我們幾乎都沒用，同時 2/1 的體質很容易被點掉
Kommand 用來拆鍋子、Sheoldred 則是用來阻止對手抽牌，沒有抽牌 = 沒有資源 = 比較不容易被翻盤

### Cascade Beanstalk/Omnath

|           Side In            |     Side Out      |
| :--------------------------: | :---------------: |
|         +1 Terminate         |  -2 Undying Evil  |
|     +1 Magus of the Moon     | -2 Lightning Bolt |
| +2 Sheoldred, the Apocalypse |                   |

這是一個需要跟對手 race 的對局，但 race 的重點是資源差
需要再對手把資源差打出來前截斷對手的資源，或是直接將對手的血線壓入斬殺範圍

### Rhinos

|          Side In          |       Side Out       |
| :-----------------------: | :------------------: |
|  +2 Chalice of the Void   | -4 Orcish Bowmasters |
| +2 Engineered Explosives  |  -2 Lightning Bolt   |
|       +1 Terminate        |    -1 Blood Moon     |
| +1 Hidetsugu Consumes All |                      |
|   +1 Kolaghan's Command   |                      |

這個對局只要有成功 scam 出一隻生物就好了，對手除了 Dead // Gone 和 Dismember 以外幾乎沒有解，將注意力放在 cascade 出來的犀牛上

### Amulate Titan

|       Side In        |     Side Out      |
| :------------------: | :---------------: |
|     +1 Terminate     | -2 Lightinig Bolt |
| +1 Magus of the Moon |                   |

好對局，用 Dauthi 將對手的泰坦或戒指抓過來用，ez game

### Burn

|           Side In            |               Side Out                |
| :--------------------------: | :-----------------------------------: |
|    +2 Chalice of the Void    | -1 Kroxa, Titan of the Death's Hunger |
|   +2 Engineered Explosives   |            -2 Thoughtseize            |
|     +2 Bonecrusher Giant     |             -1 Blood Moon             |
| +2 Sheoldred, the Apocalypse |    -4 Fable of the Mirror-Breaker     |

硬著頭皮調度到起手能一回 Grief scam 的起手，接下來基本上就是躺著打（反正對面要燒你臉也沒辦法說怎樣），剩下的注意力放在祝聖僧上就好（丟一個 X = 2 的 EE 在場上）
Sheoldred 準時拍很舒服，另外 Thoughtseize 兩點血換三點血我覺得還可以接受，同時有機會能把祝聖僧丟掉
然後用聖杯鎖 X = 1 加減躲掉一費咒語，賭對手沒上拆
...
|          Side In          |    Side Out     |
| :-----------------------: | :-------------: |
|  +2 Chalice of the Void   | -4 Thoughtseize |
|       +1 Terminate        | -2 Undying Evil |
| +1 Hidetsugu Consumes All |  -1 Blood Moon  |
|  +3 Leyline of the Void   |                 |

龍侯太會賺資源了，即便在很早的回合 scam 還是有可能拉不開資源差，同時 Unholy Heat 基本上可以把 scam 出來的生物點掉，所以這個對局可以當作中速打就好了
另外聖杯鎖 X = 1 龍侯會很痛苦，現在很多龍侯都沒帶拆了（頂多就是備牌的一張 [Cast into Fire](https://cards.scryfall.io/large/front/2/e/2ef878cb-27b6-47d8-ad11-bd20529b0e7e.jpg?1686968832)），只剩康可以處理

### Hardened Scales

|          Side In          |               Side Out                |
| :-----------------------: | :-----------------------------------: |
| +2 Engineered Explosives  |      -4 Ragavan, Nimble Pilferer      |
|       +1 Terminate        | -1 Kroxa, Titan of the Death's Hunger |
| +1 Hidetsugu Consumes All |            -4 Thoughtseize            |
|   +1 Kolaghan's Command   |                                       |
|   +1 Magus of the Moon    |                                       |
|  +3 Leyline of the Void   |                                       |

基本上猴子沒用，對面低費生物太多了，不如上更多的殺跟掃
另外要注意的是，**套件** 這個異能是在生物 **死去** 時才會觸發，如果場上有 Dauthi 或是 LotV，則死去時不會觸發套件的異能
另外雖然這個對局有克薩傳跟墨蛾地應該要上血月，但我們可能會在出血月之前就死了所以（ry
...
| +2 Engineered Explosives  |      -4 Ragavan, Nimble Pilferer      |
|       +1 Terminate        | -1 Kroxa, Titan of the Death's Hunger |
|   +2 Bonecrusher Giant    |         -2 Dauthi Voidwalker          |
| +1 Hidetsugu Consumes All |                                       |
|   +1 Magus of the Moon    |                                       |

克薩傳很難處理，即便早點出 Grief 也沒有什麼用（Grief：啊我就爛不能掉地啊
直接用 HCA && EE 掃場會比較簡單，另外如果知道對手打的是純白錘的話要提防一下有沒有 Solitude，不要腦衝 Fury scam

### Living End

|        Side In         |     Side Out      |
| :--------------------: | :---------------: |
| +2 Chalice of the Void | -2 Lightning Bolt |
| +3 Leyline of the Void |   -2 Terminate    |
|                        |   -1 Blood Moon   |

基本上起手要用備牌，最差最及也要能夠二回丟 Dauthi
另外 scam 沒有很重要，他們直接進墳也無仿
最後是 Dauthi 在這個對局很有用，詳細請看上面的 [關於 Dauthi Voidwalker 的二三事](#關於-Dauthi-Voidwalker-的二三事)
...
猴子基本上活不下來（4x Bowmasters, 4x Push, 4x March）所以全下掉
沒有上 Bonecrusher Giant 是因為這個對局最快是四回戒指，而且有 March/Sheoldred 會補血，通常沒辦法打很快

### Dimir Control

|           Side In            |         Side Out          |
| :--------------------------: | :-----------------------: |
|         +1 Terminate         | -4 Ragavan, Nimble Pilfer |
|     +2 Bonecrusher Giant     |       -1 Blood Moon       |
| +2 Sheoldred, the Apocalypse |                           |

跟創打起來差不多，不過對局上需要更迂迴的處理（躲康），起手 Grief scam 很重要

### Domain Zoo

|        Side In        |          Side Out           |
| :-------------------: | :-------------------------: |
|     +1 Terminate      | -3 Ragavan, Nimble Pilferer |
| +1 Kolaghan's Command |                             |
| +1 Magus of the Moon  |                             |
